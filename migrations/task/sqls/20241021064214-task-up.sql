...
select "CREDIT_PACKAGE".name as "組合包方案名稱",
       count(*) as "銷售數量"
from "CREDIT_PURCHASE" inner join "CREDIT_PACKAGE" on "CREDIT_PACKAGE".id = "CREDIT_PURCHASE".credit_package_id
where "CREDIT_PURCHASE".created_at >= '2024-11-01 00:00:00' and 
...
from "CREDIT_PURCHASE"
where "CREDIT_PURCHASE".purchase_at >= '2024-11-01 00:00:00' and 
...
from "COURSE_BOOKING"
where "COURSE_BOOKING".created_at >= '2024-11-01 00:00:00' and 
      "COURSE_BOOKING".created_at <= '2024-11-30 23:59:59' and 
